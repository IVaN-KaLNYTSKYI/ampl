...
export default function Interactbuttonnoactive(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "Interactbuttonnoactive")}
    >
      <View
        padding="0px 0px 0px 0px"
        position="absolute"
      ...
      >
        <Icon
          width="10.744338989257812px"
          height="5.244384765625px"
          viewBox={{
            minX: 0,
            minY: 0,
            width: 10.744338989257812,
